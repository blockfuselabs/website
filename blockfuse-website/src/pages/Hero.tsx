...
const Hero = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blockfuse Labs - Homepage</title>
        <meta
          name="description"
          content="Welcome to Blockfuse Labs, a hub for blockchain innovation and Web3 development. Explore our projects, resources, and learn how we are shaping the future of decentralized technologies."
        />
        <meta property="og:title" content="Homepage - Blockfuse Labs" />
        <meta
          property="og:description"
          content="Blockfuse Labs is at the forefront of blockchain innovation. Visit our homepage to discover our projects, learn about our mission, and find out how we are advancing decentralized technology for a better tomorrow."
        />
      ...
      <main className="h-full">
        <section className="relative flex items-center justify-center h-screen px-6 py-36 sm:px-8 md:px-16 lg:px-24"  role="region"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="p-6 border border-purple-500 dark:bg-black">
              ...
              <p className="dark:text-gray-300 text-justify text-lg">
                ...
                innovation, technical expertise, and community development
            ...
            <div className="p-6 border border-purple-500 dark:bg-black">
              ...
              <p className="dark:text-gray-300 text-justify text-lg">
                Today, Blockfuse Labs stands as a beacon of blockchain
                education, offering cutting-edge courses that cover everything
                from basic blockchain principles to advanced development,
                helping learners master the future of technology.
              </p>
            </div>
      ...
      <section
        ...
        >
          ...
          <div className="-space-y-1">
            <p className="mt-4 mx-20 text-center text-wrap dark:text-gray-300">
              ...
              upcoming cohort offers hands-on training, expert mentorship, and
            </p>
            <p className="mt-4 mx-20 text-center text-wrap dark:text-gray-300">
        ...
        {/* Section 8: FAQ */}
        <section
          className="faq-section px-6 py-20 sm:px-8 md:px-16 lg:px-24 dark:text-white"
          role="region"
          aria-labelledby="faq"
        >
          ...
          <div className="space-y-4 text-lg">
            {[
              ...
              },
              {
                ...
                answer:
                  "Anyone with a passion for learning, a curiosity about blockchain technology, and a commitment to personal and professional growth can apply. Whether you're a beginner or an experienced developer looking to enhance your skills, we welcome you!",
              },
              {
                question: "What programs does Blockfuse Labs offer?",
                answer:
                  "Blockfuse Labs offers two main programs:<ol><li><strong class='text-white'>Web2 to Web3 Preparatory Bootcamp</strong><br>Designed for beginners with no coding experience, this program teaches Web2 essentials like HTML, CSS, JavaScript, React, and Node.js to build a strong foundation for Web3 development.</li><li><strong class='text-white'>Web3 Bootcamp</strong><br>Tailored for experienced Web2 developers, this program focuses on mastering blockchain technologies, working on real-world Web3 projects, and gaining mentorship from industry experts.</li></ol>Whether you’re starting from scratch or looking to level up, we have a program for you!",
              },
              {
                question: "How do I enroll in a Blockfuse Labs cohort?",
                answer:
                  "Enrollment is easy! Visit our official website and follow the application process. Keep an eye on announcements for open registrations and deadlines. <a href='/bootcamp' class='text-purple-700 hover:text-purple-800 underline'>Click here</a> to apply.",
              },
              {
                question: "How can Blockfuse Labs help with my career?",
                answer:
                  "Blockfuse Labs equips you with in-demand skills in blockchain and Web3 development, connecting you to a network of industry professionals and providing opportunities to work on real-world projects. Our graduates are well-prepared to enter the job market, launch startups, or contribute to cutting-edge innovations.",
              },
              {
                question: "Is there a community I can join?",
                answer:
                  "Absolutely! Blockfuse Labs has a vibrant and supportive community where members collaborate, learn, and grow together. You can join our <a href='https://t.me/blockfuselabs' target='_blank' class='text-purple-700 hover:text-purple-800 underline'>Telegram Group here</a>, participate in meetups, and become part of a thriving network of developers and tech enthusiasts.",
              },
            ].map((item, index) => (
        ...
        <section className="w-full flex justify-center items-center dark:text-white h-auto sm:h-96 mx-auto p-4 sm:p-6 dark:bg-[#1F1E23]">
          <div className="space-y-5 sm:space-y-7 max-w-lg sm:max-w-none">
            ...
            <div className="-space-y-1">
              ...
              <p className="dark:text-gray-300 text-center text-lg">
                and exclusive resources from BlockTate Labs delivered straight
