...
=======
  const { getAllCohortsData, getAllCohortsError, isGetAllCohortsloading } = useCohortsQuery();
  const navigate = useNavigate();
  console.log(getAllCohortsData);
...
=======
      ...
      <section className="space-y-5 h-auto px-4 py-10 sm:px-6 md:px-16 lg:px-24 dark:text-white" role="region" aria-labelledby="about-us">
        <p className="dark:text-gray-300 text-xl pb-10 md:pb-0 lg:pb-0 leading-[26px] font-light sm:w-[90%] md:w-[700px] mx-auto text-center md:text-left md:ml-[290px]">
...
=======
            className="w-full md:w-[48%] lg:w-[45%] xl:w-[48%] border shadow-lg rounded-lg overflow-hidden cursor-pointer transition-transform transform hover:scale-105"
>>>>>>> 94d37b2366336f4c7cd841075f8a0067919e3294
          >
              <div className="p-4">
