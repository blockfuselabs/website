      ...
      <div className="flex items-center justify-center relative mb-8">
        ...
        <div className="relative text-center z-10">
          ...
          <p className="mt-4 text-lg md:text-xl w-full md:w-3/4 mx-auto dark:text-gray-300">
            ...
            advance blockchain education. Since our founding, Blockfuse Labs has
            grown into a leading educational platform, trusted by developers and
            enthusiasts alike. Today, we're proud to be driving blockchain
            education and innovation across Africa, helping learners at all
            levels build their skills and confidence.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto mb-14 mt-14">
        ...
        <div className="p-8 border border-purple-500 dark:bg-black">
          ...
          <p className="dark:text-gray-300 text-m">
            ...
            creativity, knowledge, and technology intersect to create solutions
        ...
        <div className="p-8 border border-purple-500 dark:bg-black">
          ...
          <p className="dark:text-gray-300 text-m">
            To cultivate a thriving community of skilled blockchain developers
            and pioneers in Nigeria, equipped to drive the future of technology
