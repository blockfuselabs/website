...
const TeamDetails: React.FC = () => {
  ...
  } = useTeamArticlesQuery(member?.id ?? -1);
  ...
  return (
    <>
      <Helmet>
        <html lang="en" />
        <title>Blockfuse Labs-Team Details</title>
        <meta
          name="description"
          content="Get to know the team member behind Blockfuse Labs, pioneers in the blockchain space."
        />
        <meta property="og:title" content="Blockfuse Labs Team" />
        <meta
          property="og:description"
          content="Discover the bright minds shaping the blockchain space at Blockfuse Labs."
        />
        <meta property="og:type" content="website" />
        <link rel="canonical" href={window.location.href} />
      </Helmet>
      <div className="flex justify-center items-center py-32 overflow-x-hidden dark:text-white">
        <div className="flex flex-col md:flex-row items-start gap-8 max-w-5xl w-full p-6 md:p-10 shadow-lg rounded-lg">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 w-full">
            <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
              ...
              <p className="text-base text-gray-700 text-justify dark:text-gray-400 max-w-md">
                {member.about}
              </p>
            </div>
            <img
