  ...
  return (
    <div>
      ...
      >
        ...
        <p className="dark:text-gray-300 text-xl text-justify pl-14 pb-10 md:pb-0 lg:pb-0 leading-[26px] font-light sm:w-[90%] md:w-[700px] mx-auto  md:text-left md:ml-[290px]">
