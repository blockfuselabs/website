...
const StyledCards = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
      ...
      <div className="dark:bg-black h-auto sm:h-[700px] md:h-[900px] border border-purple-500 shadow-lg overflow-hidden">
        <div
          className="h-40 sm:h-60 m-3 sm:m-5 bg-cover bg-center"
          style={{ backgroundImage: `url(${Web2})` }}
        >
      ...
      {/* </div> */}
        ...
        <div className="p-4 sm:p-6">
          <p className="dark:text-gray-300 mb-4 text-justify text-lg sm:text-base">
          This program is designed for skilled programmers who want to dive into blockchain development and build the future of Web3. If you have a strong programming background and are ready to take on the world of smart contracts and decentralized applications, this is for you!<br/><br/><br/><br/><br/><br/><br/><br/><br/>
          </p>
        </div>
        <div className="flex justify-center mb-3 mx-2 sm:mt-16">
          <a
